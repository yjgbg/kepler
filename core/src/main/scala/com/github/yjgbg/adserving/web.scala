...
object web extends ZIOAppDefault {
  ...
  def app(storage:engine.Searchine[biz.Creative,biz.Targeting,engine.Ready.Yes.type]): HttpApp[Any, Throwable] = Http.collectZIO[Request] {
