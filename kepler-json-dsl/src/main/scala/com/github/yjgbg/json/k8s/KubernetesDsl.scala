...
trait KubernetesDsl extends JsonDsl:
  opaque type Version = [A] =>> String
  given serviceV:Version["Service"] = "v1"
  given deploymentV:Version["Deployment"] = "apps/v1"
  given cronJobV:Version["CronJob"] = "bacth/v1"
  given podV:Version["Pod"] = "v1"
